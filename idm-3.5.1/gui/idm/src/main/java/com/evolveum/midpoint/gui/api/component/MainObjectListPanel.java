...
public abstract class MainObjectListPanel<O extends ObjectType> extends ObjectListPanel<O> {
	...
	private static final String ID_BUTTON_BAR_UP = "buttonBarUp";

	public MainObjectListPanel(String id, Class<O> type, TableId tableId,
			Collection<SelectorOptions<GetOperationOptions>> options, PageBase parentPage) {
	...
	protected WebMarkupContainer createTableButtonToolbar(String id) {
		System.out.println("Cretae table button toolbar" + id);
		return new ButtonBar(id, ID_BUTTON_BAR, this);
	}

	@Override
	protected WebMarkupContainer createTableButtonToolbarUp(String id) {
		System.out.println("Cretae table button toolbar" + id);
		return new ButtonBar(id, ID_BUTTON_BAR_UP, this);
	}
