...
public class PageUser extends PageAdminFocus<UserType> {
    ...
    public PageUser() {
        initialize(null);
        LOGGER.info("PRINTING LOG INFO LEVEL");
        LOGGER.debug("PRINTING LON ON DEBUG LEVEL");
        LOGGER.warn("PRINTING LOG ON WARN LEVEL");
        LOGGER.trace("PRINTING ON TRACE LEVEL");
        LOGGER.error("PRINTING ON ERROR LEVEL");
        System.out.println("Page User Defaault Constructor");
    }
    ...
    public PageUser(PageParameters parameters) {
        ...
        LOGGER.trace("PRINTING ON TRACE LEVEL");
        LOGGER.error("PRINTING ON ERROR LEVEL");
    	System.out.println("Page User Constructor, params = " + parameters.toString());
    ...
    public PageUser(final PrismObject<UserType> userToEdit) {
        ...
        LOGGER.trace("PRINTING ON TRACE LEVEL");
        LOGGER.error("PRINTING ON ERROR LEVEL");
    	System.out.println("Page User Constructor, User To Edit = " + userToEdit);
