...
public class BoxedTablePanel<T> extends BasePanel<T> implements Table {
	...
	private static final String ID_PAGING_HEADER = "pagingHeader";
	...
	private static final String ID_BUTTON_TOOLBAR_UP = "buttonToolbarUp";
	...
	protected WebMarkupContainer createHeader(String headerId) {
		return new CustomHeaderButton(headerId, ID_PAGING_HEADER, this, this);
	}
	...
	protected WebMarkupContainer createButtonToolbar(String id) {
		System.out.println("Return new WebMarkupContainer with id " + id);
	 ...
	 *
	 */
	protected WebMarkupContainer createButtonToolbarUp(String id) {
		System.out.println("Return new WebMarkupContainer with id " + id);
		return new WebMarkupContainer(id);
	}
	...
	private static class CustomHeaderButton extends Fragment {

		public CustomHeaderButton(String id, String markupId, BoxedTablePanel markupProvider, Table table) {
			super(id, markupId, markupProvider);
			setOutputMarkupId(true);
		...
		private void initLayout(final BoxedTablePanel boxedTablePanel, final Table table) {
			WebMarkupContainer buttonToolbar = boxedTablePanel.createButtonToolbar(ID_BUTTON_TOOLBAR_UP);
			add(buttonToolbar);
